window.nkWindow =
{
    ...
    ShowDirectoryPicker: function (uid) {
        var w = nkJSObject.GetObject(uid);
        var pr = w.showDirectoryPicker();
        return nkJSObject.RegisterObject(pr);
    },
    ShowOpenFilePicker: function (uid) {
        var w = nkJSObject.GetObject(uid);
        var pr = w.showOpenFilePicker();
        return nkJSObject.RegisterObject(pr);
    },
    ShowSaveFilePicker: function (uid) {
        var w = nkJSObject.GetObject(uid);
        var pr = w.showSaveFilePicker();
        return nkJSObject.RegisterObject(pr);
    },
